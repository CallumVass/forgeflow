...
import { prepareCreateIssueSkillContext, prepareCreateIssuesSkillContext } from "../../skills/index.js";
...
async function runCreateIssueInner(idea: string, pctx: PipelineContext) {
  ...
  const prepared = await prepareCreateIssueSkillContext(idea, pctx);
  pctx = prepared.pctx;
...
async function runCreateIssuesInner(pctx: PipelineContext) {
  ...
  const prepared = await prepareCreateIssuesSkillContext(pctx);
  pctx = prepared.pctx;
